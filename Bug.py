...
if __name__ == '__main__':
    ...
    # news_class_sina = ['blk12', 'blk12', 'blk12', 'blk2 imp', 'phdnews_txt fr', 'important-news', 'p_middle']  # 链接在html中div的类别
    ...
    news_class_163 = ['area-left', 'area-left', 'img', 'area-main', 'mod_bd', 'news_textList_top',
                   'ns-mr60']  # 链接在html中div的id
    image_class_163 = ['f_center', 'f_center', 'f_center', 'f_center', 'f_center', 'f_center', 'f_center']  # 图片在html中div的类,今日头条不用这个
